...
class PosterAnalysisTool:
    def __init__(self, root):
        ...
        icon_path = r"C:\Users\ShySkill\Downloads\APUSH\images\sovietunion.PNG"
        try:
            # Load the image
            icon_image = Image.open(icon_path)
            
            # Convert to the format Tkinter needs for window icons
    ...
    def load_decoration_images(self):
        """Load decorative images for welcome screen"""
        try:
            # Try to load some example images - replace these with your actual image paths
            left_img = Image.open(r"C:\Users\ShySkill\Downloads\APUSH\images\sovietunion.PNG") if os.path.exists(r"C:\Users\ShySkill\Downloads\APUSH\images\sovietunion.PNG") else None
            right_img = Image.open(r"C:\Users\ShySkill\Downloads\APUSH\images\Flag_of_the_United_States.png") if os.path.exists(r"C:\Users\ShySkill\Downloads\APUSH\images\Flag_of_the_United_States.png") else None
    ...
    def create_welcome_screen(self):
        ...
        try:
            poster_path = r"C:\Users\ShySkill\Downloads\APUSH\posters\poster.jpg"
